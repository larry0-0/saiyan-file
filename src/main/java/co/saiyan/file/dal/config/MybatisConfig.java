package co.saiyan.file.dal.config;

import co.saiyan.common.uidgen.annonation.EnableUidGenerator;
...
@Configuration
@EnableUidGenerator
@MapperScan(basePackages = {"co.saiyan.file.dal.mapper"})
...
//        bean.setTypeHandlersPackage("co.saiyan.player.dal.handler");
